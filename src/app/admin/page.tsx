  ...
  if (!isAuthenticated) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-slate-950 p-4 relative overflow-hidden">
        ...
        {isAutoWaiting ? (
          <Card className="w-full max-w-md bg-slate-900/90 backdrop-blur-2xl border border-blue-500/30 p-12 rounded-[3rem] shadow-[0_0_50px_rgba(37,99,235,0.2)] text-center space-y-8 animate-in fade-in zoom-in-95 duration-500 z-50">
            ...
            <div className="space-y-3">
              <h2 className="text-2xl font-black text-white uppercase tracking-tight">Verifica Accesso</h2>
              <p className="text-blue-400 font-bold text-sm animate-pulse tracking-widest uppercase">Tramite Server Master...</p>
            </div>
            <p className="text-slate-500 text-xs font-medium leading-relaxed">
              Controlla il tuo dispositivo Blackview e autorizza la richiesta per entrare nel sistema Titanium.
            </p>
            <Button 
              variant="ghost" 
              className="text-slate-500 hover:text-white text-[10px] font-black uppercase tracking-widest"
              onClick={() => setIsAutoWaiting(false)}
            >
              Annulla Richiesta
            </Button>
          </Card>
